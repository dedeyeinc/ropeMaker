...
def ropeMakerUI():
    ...
    global btn7
    btn7 = cmds.button(l='CV Curve',c='ropeMakerUI.cvCurve()',w=80,p=cl10)
    cmds.separator(hr=0,width=10,p=cl10)
    global btn8
    btn8 = cmds.button(l='EP Curve',c='ropeMakerUI.epCurve()',w=80,p=cl10)
    cmds.separator(hr=0,width=10,p=cl10)
    global btn9
    btn9 = cmds.button(l='Bezier Curve',c='ropeMakerUI.bezierCurve()',w=80,p=cl10)
    global btn6
    btn6 = cmds.button(l='Draw Curve',c='ropeMakerUI.drawCurve()',p=fl1)
    ...
    global btn5
    btn5 = cmds.button(l='Rebuild Curve',c='ropeMakerUI.rebuildCurve()',p=cl9)
    
    global btn1
    btn1 = cmds.button(l='Create Geo Base',c='ropeMakerUI.makeGeo()',p=fl1)
    
    global btn2
    btn2 = cmds.button(l='Delete UV Pin',c='ropeMakerUI.deleteUVPin()',p=fl1)
    ...
    global btn0
    btn0 = cmds.button(l='Extrude Geo (Make Rope)',c='ropeMakerUI.makeRope()',p=fl1)
    
    cmds.separator(hr=1,height=1,p=fl1)
    cl6 = cmds.rowColumnLayout(nc=5,nch=5,h=25,w=150,p=fl1)
    global centerJoints
    centerJoints = cmds.checkBox(l='Add Center Joints',v=1,cc='ropeMakerUI.changeAddCenterJoints()',p=cl6)
    global centerCurve
    ...
    global btn3
    btn3 = cmds.button(l='Attach Geo to Curve',c='ropeMakerUI.attachGeoToCurve()',w=130,p=cl8)
    cmds.separator(hr=0,width=10,p=cl8)
    global btn4
    btn4 = cmds.button(l='Make Ribbon',c='ropeMakerUI.makeRibbon()',w=130,p=cl8)
...
def makeRope():
    from Library import ropeMaker
    import imp
    imp.reload(ropeMaker)
    ropeMaker.makeRope()

def makeGeo():
    from Library import ropeMaker_makeGeo
    import imp
    imp.reload(ropeMaker_makeGeo)
    ropeMaker_makeGeo.makeGeo()

def attachGeoToCurve():
    from Library import ropeMakerUI_addCenterCurve
    import imp
...
def makeRibbon():
    from Library import ropeMaker_ribbonizer
    import imp
